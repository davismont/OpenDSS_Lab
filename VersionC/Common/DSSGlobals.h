...
//        typedef TThread inherited;
    ...
    */
    ...
    // Us it for exchanging data between actors async
    //*******************************************************************************************************

    // Thread-safe queue
    // Inpired by the code provided here: https://www.geeksforgeeks.org/implement-thread-safe-queue-in-c/
    template <typename T>
    class TSQueue
    {
        private:
