            ...
            Begin
               ...
               Begin // Attempt to change storage dispatch
                 If Not (FleetState=STORE_DISCHARGING) Then
                  Begin
                    SetFleetToDischarge;
                    if ActiveCircuit[ActorID].Solution.ControlIteration = 1 then StorekWChanged := True; // if not already discharging, force new power flow.
                  End;
            ...
            Begin
               ...
               Begin // Attempt to change storage kW charge
                   If Not (FleetState=STORE_CHARGING) Then Begin
                      SetFleetToCharge;
                      if ActiveCircuit[ActorID].Solution.ControlIteration = 1 then StorekWChanged := True; // if not already charging, force new power flow.
                   End;
