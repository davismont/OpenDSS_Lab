...
The pyControl object runs under another application called the DSSpyServer. This application requires the following packages installed in your local python installation:
...
3. Run the executable copies with the other 2 .py scripts. This will register the DSSpyServer for OpenDSS in your system. Use the executable accordingly to your OS.
4. Ready to go...
